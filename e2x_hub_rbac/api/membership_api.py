...
from ..auth.rbac import Role, RoleAssignment, User
...
class MembershipAPI(BaseAPI):
    ...
    async def add_hub_admins(self, user: User, usernames: list[str]):
    ...
    async def remove_hub_admins(self, user: User, usernames: list[str]):
    ...
    async def list_hub_admins(self, user: User) -> list[str]:
    ...
    async def add_course_creators(self, user: User, usernames: list[str]):
    ...
    async def list_instructors(self, user: User, course_id: str, term_id: str) -> list[str]:
    ...
    async def list_teaching_assistants(self, user: User, course_id: str, term_id: str) -> list[str]:
    ...
    async def add_observers(self, user: User, course_id: str, term_id: str, usernames: list[str]):
    ...
    async def list_observers(self, user: User, course_id: str, term_id: str) -> list[str]:
    ...
    async def add_students(self, user: User, course_id: str, term_id: str, usernames: list[str]):
    ...
    async def remove_students(self, user: User, course_id: str, term_id: str, usernames: list[str]):
    ...
    async def list_students(self, user: User, course_id: str, term_id: str) -> list[str]:
